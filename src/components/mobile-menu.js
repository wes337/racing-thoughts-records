...
export default function MobileMenu() {
  ...
  const [mobileMenuOpen, setMobileMenuOpen, toggleMobileMenuOpen] = useLayout(
    useShallow((state) => [
      state.mobileMenuOpen,
      state.setMobileMenuOpen,
      state.toggleMobileMenuOpen,
    ])
  );
  ...
  return (
    <>
      ...
      {createPortal(
        <div
          className={`mobile-menu-bg md:hidden fixed top-0 w-full h-full bg-white z-5 ${
