  ...
  return (
    ...
    >
      <div className="relative w-full h-full aspect-square overflow-hidden">
        <Image
          className="absolute top-0 left-0 w-full h-full mix-blend-multiply z-[-1] opacity-80 group-hover:opacity-100"
          src={`/images/box-large.png`}
          width={1011}
          height={982}
          alt=""
        />
        <div className="bg-gray-500/10 m-1 md:m-2 rounded-lg">
          <Image
      ...
      <div>
        <div
          className={`flex items-center font-mono font-bold h-[36px] lg:h-[40px] leading-6  ${
            longTitle
              ? "text-md tracking-[-2px] leading-none md:leading-6"
